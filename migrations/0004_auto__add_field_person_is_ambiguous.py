...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.is_ambiguous'
        db.add_column(u'sourcenet_person', 'is_ambiguous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.is_ambiguous'
        db.delete_column(u'sourcenet_person', 'is_ambiguous')
    ...
    models = {
        ...
        u'sourcenet.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_ambiguous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
