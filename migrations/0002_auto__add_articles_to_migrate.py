...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Articles_To_Migrate'
        db.create_table(u'sourcenet_articles_to_migrate', (
            ...
            ('article_type', self.gf('django.db.models.fields.CharField')(default=u'news', max_length=255, blank=True)),
        ))
        db.send_create_signal(u'sourcenet', ['Articles_To_Migrate'])


    def backwards(self, orm):
        # Deleting model 'Articles_To_Migrate'
        db.delete_table(u'sourcenet_articles_to_migrate')
