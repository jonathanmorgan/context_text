...
class ArticleCodingForm( forms.ModelForm ):
    ...
    class Meta:
        ...
        exclude = [ 'article_data', 'original_person', 'match_confidence_level', 'capture_method', 'create_date', 'last_modified', 'source_type', 'subject_type', 'name', 'title', 'more_title', 'organization', 'document', 'topics', 'source_contact_type', 'source_capacity', 'localness', 'notes' ]
