...
CONTEXT_TEXT.regex_compress_white_space = /\s+/g
 ...
 */
CONTEXT_TEXT.compress_internal_white_space = function( string_IN ) 
{
    // return reference
    var string_OUT = null;
...
CONTEXT_TEXT.decode_html = function( html_IN )
{
 ...
 */
CONTEXT_TEXT.get_selected_value_for_id = function( select_id_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.get_selected_value_for_id";
    
    // just call get_value_for_id()
    value_OUT = CONTEXT_TEXT.get_value_for_id( select_id_IN, null );
    
    return value_OUT;
    
} //-- END function CONTEXT_TEXT.get_selected_value_for_id() --//
 ...
 */
CONTEXT_TEXT.get_value_for_id = function( id_IN, default_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.get_value_for_id";
    var is_id_OK = false;
    var element = null;
    var value = "";
    
    // is ID passed in OK?
    is_id_OK = CONTEXT_TEXT.is_string_OK( id_IN );
    if ( is_id_OK == true )
    {
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): element ID = " + id_IN + "; value = " + value_OUT );
    
    return value_OUT;
    
} //-- END function CONTEXT_TEXT.get_value_for_id() --//
 ...
 */
CONTEXT_TEXT.is_boolean_OK = function( value_IN )
{
...
} //-- END function CONTEXT_TEXT.is_boolean_OK() --//
 ...
 */
CONTEXT_TEXT.is_integer_OK = function( integer_IN, min_value_IN )
{
...
} //-- END function CONTEXT_TEXT.is_integer_OK() --//
 ...
 * @returns {boolean} - if string is undefined, null, or "", returns false.  Otherwise returns true.
 */
CONTEXT_TEXT.is_string_OK = function( value_IN, do_allow_empty_IN )
{
    ...
    // initialize
    is_value_ok = CONTEXT_TEXT.is_boolean_OK( do_allow_empty_IN );
...
} //-- END function CONTEXT_TEXT.is_string_OK() --//
 ...
 *    nothing.
 */
CONTEXT_TEXT.log_message = function( message_IN )
{
    
    // declare variables
    var output_flag = true;
    
    // set to CONTEXT_TEXT.debug_flag
    output_flag = CONTEXT_TEXT.debug_flag;
...
} //-- END function CONTEXT_TEXT.log_message() --//
 ...
 */
CONTEXT_TEXT.output_status_messages = function( status_message_array_IN )
{
    
    // declare variables.
    var me = "CONTEXT_TEXT.output_status_messages";
...
} //-- END function CONTEXT_TEXT.output_status_messages() --//
 ...
 * @returns {string} - selected value of select matching ID passed in, else null if error.
 */
CONTEXT_TEXT.set_selected_value_for_id = function( select_id_IN, select_value_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.set_selected_value_for_id";
    var is_select_id_OK = false;
    var select_element = null;
    
    // just call CONTEXT_TEXT.set_value_for_id()
    value_OUT = CONTEXT_TEXT.set_value_for_id( select_id_IN, select_value_IN );
    
    CONTEXT_TEXT.log_message( "In " + me + "(): <select> ID = " + select_id_IN + "; value = " + value_OUT );
    
    return value_OUT;
    
} //-- END function CONTEXT_TEXT.set_selected_value_for_id() --//
 ...
 */
CONTEXT_TEXT.set_value_for_id = function( element_id_IN, value_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.set_value_for_id";
    var is_element_id_OK = false;
    var element = null;
    
    // select ID passed in OK?
    is_element_id_OK = CONTEXT_TEXT.is_string_OK( element_id_IN );
    if ( is_element_id_OK == true )
    {
        ...
        // get value.
        value_OUT = CONTEXT_TEXT.get_value_for_id( element_id_IN );
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): HTML element ID = " + element_id_IN + "; value = " + value_OUT );
    
    return value_OUT;
    
} //-- END function CONTEXT_TEXT.set_value_for_id() --//
