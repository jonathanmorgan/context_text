 ...
 * @constructor
 */
CONTEXT_TEXT.FindInText = function()
{
    
    // ! -----> Class variables

    // Find in Article Text - Dynamic CSS class names
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT = "foundInText";
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS = "foundInTextMatchedWords";
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_RED = "foundInTextRed";
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_RED = "foundInTextMatchedWordsRed";
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_GREEN = "foundInTextGreen";
    CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_GREEN = "foundInTextMatchedWordsGreen";
    
    // defaults:
    CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_P_MATCH = CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT;
    CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_WORD_MATCH = CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS;
    
    // Find in Article Text - HTML element IDs
    CONTEXT_TEXT.FindInText.INPUT_ID_TEXT_TO_FIND_IN_ARTICLE = "text-to-find-in-article";
    
    // Find in Article Text - HTML for matched word highlighting
    CONTEXT_TEXT.FindInText.HTML_SPAN_TO_CLASS = "<span class=\""
    CONTEXT_TEXT.FindInText.HTML_SPAN_AFTER_CLASS = "\">";
    CONTEXT_TEXT.FindInText.HTML_SPAN_CLOSE = "</span>";
    
    // words to ignore
    CONTEXT_TEXT.FindInText.text_to_ignore_list = [];
    // CONTEXT_TEXT.FindInText.text_to_ignore_list.push( "the" );
    // CONTEXT_TEXT.FindInText.text_to_ignore_list.push( "The" );
    
    // regexp compress internal white space
    CONTEXT_TEXT.regex_compress_internal_white_space = /\s+/g
    
    // regexp escape regex.
    
    // bobince - https://stackoverflow.com/questions/3561493/is-there-a-regexp-escape-function-in-javascript/3561711#3561711
    //CONTEXT_TEXT.FindInText.regex_escape_regex = /[-\/\^$*+?.()|[]{}]/g
    ...
    //CONTEXT_TEXT.FindInText.regex_escape_regex = /[-[\]{}()*+?.,\\^$|#\s]/g

    // https://simonwillison.net/2006/Jan/20/escape/
    CONTEXT_TEXT.FindInText.regex_specials = [
      '/', '.', '*', '+', '?', '|',
      '(', ')', '[', ']', '{', '}', '\\'
    ];
    CONTEXT_TEXT.FindInText.regex_escape_regex_string = '(\\' + CONTEXT_TEXT.FindInText.regex_specials.join('|\\') + ')';
    CONTEXT_TEXT.FindInText.regex_escape_regex = new RegExp(
      CONTEXT_TEXT.FindInText.regex_escape_regex_string,
      'g'
    );
    
    // element cleanup list
    CONTEXT_TEXT.FindInText.cleanup_in_these_elements = [];
    CONTEXT_TEXT.FindInText.cleanup_in_these_elements.push( "p" );
    CONTEXT_TEXT.FindInText.cleanup_in_these_elements.push( "h3" );    
    CONTEXT_TEXT.FindInText.cleanup_in_these_elements.push( "li" );
    ...
    this.css_class_matched_paragraph = CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_P_MATCH;
    this.css_class_matched_words = CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_WORD_MATCH;
    ...
    this.css_class_list_found_in_text.push( CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_P_MATCH );
    
    // list of known found in text word classes
    this.css_class_list_found_in_text_words = [];
    this.css_class_list_found_in_text_words.push( CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_WORD_MATCH  );
...
} //-- END CONTEXT_TEXT.FindInText constructor --//
 ...
 * Preconditions: None.
 *
 * Postconditions: Updates CONTEXT_TEXT.FindInText.text_to_ignore_list.
 */
CONTEXT_TEXT.FindInText.add_to_ignore_list = function( ignore_list_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.add_to_ignore_list";
    ...
    if ( ( ignore_list_IN !== undefined ) && ( ignore_list_IN != null ) && ( ignore_list_IN.length > 0 ) )
    {
        ...
        CONTEXT_TEXT.FindInText.text_to_ignore_list = CONTEXT_TEXT.FindInText.text_to_ignore_list.concat( ignore_list_IN )
    }

} //-- END function CONTEXT_TEXT.add_to_ignore_list() --//


/**
 * Empties CONTEXT_TEXT.FindInText.text_to_ignore_list.
 *
 * Preconditions: None.
 *
 * Postconditions: Empties CONTEXT_TEXT.FindInText.text_to_ignore_list.
 */
CONTEXT_TEXT.FindInText.clear_ignore_list = function()
{
...
} //-- END function CONTEXT_TEXT.clear_ignore_list() --//
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.FindInText.clear_word_matches_in_element = function( element_IN, word_class_list_IN )
{

    // declare variables.
    var me = "CONTEXT_TEXT.FindInText.clear_word_matches_in_element";
        ...
        if ( span_index > -1 )
        {
            ...
            span_jquery_list.each( 
                function()
                {
                    ...
                    //CONTEXT_TEXT.log_message( "**** In " + me + "(): span_html = \"" + span_html + "\"; span_text = \"" + span_text + "\"" );
 ...
 */
CONTEXT_TEXT.FindInText.compress_internal_white_space = function( string_IN ) 
{
    // return reference
    var string_OUT = null;
    ...
    string_OUT = string_IN.replace( CONTEXT_TEXT.regex_compress_white_space, ' ' );
    
    return string_OUT;

} //-- end function CONTEXT_TEXT.compress_internal_white_space --//
 ...
 */
CONTEXT_TEXT.FindInText.create_regex = function( regex_string_IN, be_case_sensitive_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.create_regex";
    var escaped_string = null;
    var regex_flags = "";
    
    // escape string
    escaped_string = regex_string_IN.replace( CONTEXT_TEXT.FindInText.regex_escape_regex, '\\$1' );
...
CONTEXT_TEXT.FindInText.is_text_ignored = function( text_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.is_text_ignored";
    ...
    lower_case_ignore_list = CONTEXT_TEXT.FindInText.text_to_ignore_list.map(
        function( value )
        {
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.FindInText.prototype.clear_all_find_in_text_matches = function( element_id_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.clear_all_find_in_text_matches";
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.FindInText.prototype.clear_find_in_text_matches = function( element_id_IN,
                                                                      wrapper_class_list_IN,
                                                                      word_class_list_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.clear_find_in_text_matches";
    ...
    cleanup_element_list = CONTEXT_TEXT.FindInText.cleanup_in_these_elements;
        ...
        article_elements.each( function()
            {
                ...
                CONTEXT_TEXT.FindInText.clear_word_matches_in_element( this, word_class_list_IN )
 ...
 */
CONTEXT_TEXT.FindInText.prototype.config_green_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.config_green_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    this.set_css_class_matched_paragraph( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_GREEN );
    this.set_css_class_matched_words( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_GREEN );
 ...
 * Postconditions: Updates instance to highlight in red.
 */
CONTEXT_TEXT.FindInText.prototype.config_red_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.config_red_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    this.set_css_class_matched_paragraph( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_RED );
    this.set_css_class_matched_words( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_RED );
 ...
 */
CONTEXT_TEXT.FindInText.prototype.config_yellow_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.config_yellow_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    this.set_css_class_matched_paragraph( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT );
    this.set_css_class_matched_words( CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS );
 ...
 *     stands out.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_in_string = function( find_text_IN,
                                                               string_IN )
{
    ...
    // declare variables.
    var me = "CONTEXT_TEXT.FindInText.prototype.find_text_in_string";
    ...
    // CONTEXT_TEXT.log_message( "In " + me + "(): find text \"" + find_text_IN + "\"; element text = " + work_text );
    
    // get current find item.
    current_find_text = find_text_IN;
    
    // is it something we ignore?
    is_ignored = CONTEXT_TEXT.FindInText.is_text_ignored( current_find_text );
    if ( is_ignored == false )
    {
        ...
        else
        {
            ...
            // ...regex.
            current_find_regex = CONTEXT_TEXT.FindInText.create_regex( current_find_text, false );
        ...
        if ( found_index >= 0 )
        {
            ...
            if ( be_case_sensitive == true )
            {
                ...
                matched_words_html = CONTEXT_TEXT.HTML_SPAN_TO_CLASS;
                matched_words_html += match_word_css_class;
                matched_words_html += CONTEXT_TEXT.HTML_SPAN_AFTER_CLASS;
                matched_words_html += current_find_text;
                matched_words_html += CONTEXT_TEXT.HTML_SPAN_CLOSE;
            ...
            else
            {
                ...
                //{
                //    //CONTEXT_TEXT.log_message( "**** In " + me + "(): MATCH \"" + find_text_IN + "\", work_text = \"" + work_text + "\"" );
                //    CONTEXT_TEXT.log_message( "**** In " + me + "(): unique_matches_array = \"" + unique_matches_array + "\"" );
                //    CONTEXT_TEXT.log_message( "**** In " + me + "(): matches_array = \"" + matches_array + "\"" );
                //}
            ...
            {
                //CONTEXT_TEXT.log_message( "**** In " + me + "(): MATCH \"" + find_text_IN + "\", work_text = \"" + work_text + "\"" );
                CONTEXT_TEXT.log_message( "**** In " + me + "(): MATCH \"" + find_text_IN + "\"" );
            }
        ...
        else
        {
            if ( local_debug_flag == true )
            {
                //CONTEXT_TEXT.log_message( "**** In " + me + "(): NO MATCH \"" + find_text_IN + "\", work_text = \"" + work_text + "\"" );
                CONTEXT_TEXT.log_message( "**** In " + me + "(): NO MATCH \"" + find_text_IN + "\"" );
            }
    ...
    else
    {
        ...
        CONTEXT_TEXT.log_message( "**** In " + me + "(): Ignoring \"" + current_find_text + "\", text_to_ignore_list = \"" + CONTEXT_TEXT.FindInText.text_to_ignore_list + "\"" );
...
} //-- END function CONTEXT_TEXT.find_text_in_string --//
 ...
 *     stands out.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_list_in_string = function( string_IN,
                                                                    find_text_list_IN )
{
    ...
    // declare variables.
    var me = "CONTEXT_TEXT.FindInText.prototype.find_text_list_in_string";
    var search_in_text = null;
    var work_text = "";
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): find text list = " + find_text_list_IN + "; element text = " + work_text );
...
} //-- END function CONTEXT_TEXT.find_text_list_in_string --//
 ...
 *     passed in.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_list_in_element_html = function( jquery_element_IN,
                                                                          find_text_list_IN )
{
    ...
    // declare variables.
    var me = "CONTEXT_TEXT.FindInText.prototype.find_text_list_in_element_html";
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): find text list = " + find_text_list_IN + "; element HTML = " + element_html );
    ...
    else
    {
        ...
        if ( updated_html != element_html )
        {
            ...
            CONTEXT_TEXT.log_message( "In " + me + "(): updated_html = " + updated_html + "; element HTML = " + element_html );
...
} //-- END function CONTEXT_TEXT.find_text_list_in_element_html --//
 ...
 *     passed in.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_list_in_element_text = function( jquery_element_IN,
                                                                          find_text_list_IN )
{
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): find text list = " + find_text_list_IN + "; element text = " + element_text );
...
} //-- END function CONTEXT_TEXT.find_text_list_in_element_text --//
 ...
 *     passed in.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_in_element = function( jquery_element_IN,
                                                                find_text_list_IN,
                                                                fail_over_to_text_IN )
{
    ...
    // declare variables.
    var me = "CONTEXT_TEXT.FindInText.prototype.find_text_in_element";
    var ignore_wrapper_element = false;
    var jquery_element = null;
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): where_to_look = " + where_to_look + "; use_match_text = " + use_match_text + "; jquery_element tagName = " + jquery_element.get( 0 ).tagName + ", class = " + jquery_element.attr("class") + " and id = " + jquery_element.attr("id") );
    ...
    if ( use_match_text == true )
    {
        ...
        for ( find_text_index = 0; find_text_index < find_text_count; find_text_index++ )
        {
            ...
            CONTEXT_TEXT.log_message( "In " + me + "(): current_find_text = \"" + current_find_text + "\"" );
            ...
            if ( is_ignored == false )
            {
                ...
                match_text_regex = CONTEXT_TEXT.FindInText.create_regex( current_find_text, be_case_sensitive );
                
                CONTEXT_TEXT.log_message( "In " + me + "(): match_text_regex = \"" + match_text_regex + "\"" );
...
} //-- END function CONTEXT_TEXT.find_text_in_element --//
 ...
 *     passed in.
 */
CONTEXT_TEXT.FindInText.prototype.find_text_in_p_tag = function( p_tag_jquery_IN,
                                                              find_text_list_IN,
                                                              fail_over_to_text_IN )
{
    ...
    // declare variables.
    var me = "CONTEXT_TEXT.find_text_in_p_tag";
...
} //-- END function CONTEXT_TEXT.find_text_in_p_tag --//
 ...
 * Postconditions: None.
 */
CONTEXT_TEXT.FindInText.prototype.get_elements_by_name = function( look_in_element_id_IN, element_name_to_find_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.get_elements_by_name";
    var jquery_element = null;
 ...
 * Postconditions: None.
 */
CONTEXT_TEXT.FindInText.prototype.get_paragraphs = function( element_id_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.get_paragraphs";
...
CONTEXT_TEXT.FindInText.prototype.get_css_class_matched_paragraph = function()
{
    ...
    if ( value_OUT === undefined )
    {
        ...
        this.set_css_class_matched_paragraph( CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_P_MATCH );
...
CONTEXT_TEXT.FindInText.prototype.get_css_class_matched_words = function()
{
    ...
    if ( value_OUT === undefined )
    {
        ...
        // undefined - set to default, then return default.
        this.set_css_class_matched_words( CONTEXT_TEXT.FindInText.CSS_CLASS_DEFAULT_WORD_MATCH );
...
CONTEXT_TEXT.FindInText.prototype.get_element_to_search = function()
{
 ...
 */
CONTEXT_TEXT.FindInText.prototype.match_text = function( node, regex, callback, excludeElements )
{ 
    ...
    // declare variables
    var me = "CONTEXT_TEXT.FindInText.prototype.match_text";
    var debug_message = "";
    var child = null;
    ...
    {
        CONTEXT_TEXT.log_message( debug_message + "; found regex match ( regex = " + regex + " ) in node HTML = " + node_html );
    }
    
    // is regex in text?
    if ( node_text.search( regex ) > -1 )
    {
        CONTEXT_TEXT.log_message( debug_message + "; found regex match ( regex = " + regex + " ) in node text = " + node_text );
    }
                ...
                child.data.replace( regex, function( all )
                    {
                        ...
                        CONTEXT_TEXT.log_message( "In " + me + "(): args = " + args + "; found match all = " + all );
...
CONTEXT_TEXT.FindInText.prototype.set_css_class_matched_paragraph = function( value_IN )
{
...
CONTEXT_TEXT.FindInText.prototype.set_css_class_matched_words = function( value_IN )
{
...
CONTEXT_TEXT.FindInText.prototype.set_element_to_search = function( value_IN )
{
...
// create instance
CONTEXT_TEXT.text_finder = new CONTEXT_TEXT.FindInText()
 ...
 */
CONTEXT_TEXT.clear_find_in_text = function( color_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.clear_find_in_text";
    var article_paragraphs = null;
    
    // clear matches for color.
    CONTEXT_TEXT.clear_highlight_by_color( color_IN );

    // get text-to-find-in-article text field, set value to "".
    CONTEXT_TEXT.send_text_to_find_input( "" );

} //-- END function CONTEXT_TEXT.clear_find_in_text() --//
 ...
 *     "foundInText".  Wipes input with id "text-to-find-in-article".
 */
CONTEXT_TEXT.clear_highlight_by_color = function( color_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.clear_green_highlight";
    
    // declare variables
    var me = "CONTEXT_TEXT.config_text_finder_color";
    ...
    if ( color_IN !== undefined )
    {
        ...
        else if ( color_IN == "red" )
        {
            ...
            // clear red highlight.
            CONTEXT_TEXT.clear_red_highlight();
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.clear_green_highlight = function()
{
    ...
    CONTEXT_TEXT.text_finder.clear_find_in_text_matches(
        CONTEXT_TEXT.DIV_ID_ARTICLE_BODY,
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_GREEN ],
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_GREEN ]
    );
                
} //-- END function CONTEXT_TEXT.clear_green_highlight() --//
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.clear_red_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.clear_red_highlight";
    
    // clear find in text matches
    CONTEXT_TEXT.text_finder.clear_find_in_text_matches(
        CONTEXT_TEXT.DIV_ID_ARTICLE_BODY,
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_RED ],
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS_RED ]
    );
                
} //-- END function CONTEXT_TEXT.clear_red_highlight() --//
 ...
 *     "foundInText".
 */
CONTEXT_TEXT.clear_yellow_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.clear_yellow_highlight";
    
    // clear find in text matches
    CONTEXT_TEXT.text_finder.clear_find_in_text_matches(
        CONTEXT_TEXT.DIV_ID_ARTICLE_BODY,
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT ],
        [ CONTEXT_TEXT.FindInText.CSS_CLASS_FOUND_IN_TEXT_MATCHED_WORDS ]
    );
                
} //-- END function CONTEXT_TEXT.clear_yellow_highlight() --//


/**
 * Configures CONTEXT_TEXT.text_finder to highlight in green.
 *
 * Preconditions: None.
 *
 * Postconditions: Updates CONTEXT_TEXT.text_finder to highlight in yellow.
 */
CONTEXT_TEXT.config_text_finder_color = function( color_IN )
{
    ...
    if ( color_IN !== undefined )
    {
        if ( color_IN == "yellow" )
        {
            ...
            // configure CONTEXT_TEXT.text_finder for red highlight.
            CONTEXT_TEXT.config_text_finder_yellow_highlight();
        ...
        else if ( color_IN == "red" )
        {
            ...
            // configure CONTEXT_TEXT.text_finder for red highlight.
            CONTEXT_TEXT.config_text_finder_red_highlight();
            
        }
        else if ( color_IN == "green" )
        {
        
            // configure CONTEXT_TEXT.text_finder for green highlight.
            CONTEXT_TEXT.config_text_finder_green_highlight();
 ...
 * Postconditions: Updates CONTEXT_TEXT.text_finder to highlight in yellow.
 */
CONTEXT_TEXT.config_text_finder_green_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.config_text_finder_green_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    CONTEXT_TEXT.text_finder.config_green_highlight();
    
}
  

/**
 * Configures CONTEXT_TEXT.text_finder to highlight in red.
 *
 * Preconditions: None.
 *
 * Postconditions: Updates CONTEXT_TEXT.text_finder to highlight in red.
 */
CONTEXT_TEXT.config_text_finder_red_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.config_text_finder_red_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    CONTEXT_TEXT.text_finder.config_red_highlight();
 ...
 * Postconditions: Updates CONTEXT_TEXT.text_finder to highlight in yellow.
 */
CONTEXT_TEXT.config_text_finder_yellow_highlight = function()
{
    
    // declare variables
    var me = "CONTEXT_TEXT.config_text_finder_yellow_highlight";
    
    // configure CONTEXT_TEXT.text_finder
    CONTEXT_TEXT.text_finder.config_yellow_highlight();
 ...
 */
CONTEXT_TEXT.find_strings_in_article_text = function( find_text_list_IN, clear_existing_matches_IN, color_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.find_strings_in_article_text";
    var string_count = -1;
    ...
    // configure color.
    CONTEXT_TEXT.config_text_finder_color( color_IN );
     
    // clear any previous matches?
    do_clear_matches = clear_existing_matches_IN;
    is_boolean_OK = CONTEXT_TEXT.is_boolean_OK( do_clear_matches )
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): find_text_list_IN = " + find_text_list_IN );
    ...
    if ( is_text_OK == true )
    {
        ...
        // do we ignore <p>-tags?
        //if ( CONTEXT_TEXT.article_text_ignore_p_tags == true )
        //{
        if ( force_ignore_wrapper_element == true )
        {
            
            CONTEXT_TEXT.log_message( "In " + me + "(): ignore p tags" );

            // set text finder to ignore wrapper element.
            saved_ignore_in_wrapper_element = CONTEXT_TEXT.text_finder.ignore_wrapper_element
        ...
        article_text_element = CONTEXT_TEXT.get_article_body()
        
        
        // just search in the article text element.
        CONTEXT_TEXT.text_finder.find_text_in_element( article_text_element, find_in_text_list );
        ...
        if ( force_ignore_wrapper_element == true )
        {
            ...
            CONTEXT_TEXT.text_finder.ignore_wrapper_element = saved_ignore_in_wrapper_element
        }
        
    } //-- END to make sure we have text. --//

} //-- END function CONTEXT_TEXT.find_strings_in_article_text() --//
// ! ==> list of strings --> CONTEXT_TEXT.text_finder.find_text_in_element
 ...
 *     passed in are assigned "foundInText".
 */
CONTEXT_TEXT.find_in_article_text = function( find_text_IN, clear_existing_matches_IN, color_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.find_in_article_text";
    var find_in_text_list = null;
    var is_text_OK = false;
    
    CONTEXT_TEXT.log_message( "In " + me + "(): find_text_IN = " + find_text_IN + "; clear? = " + clear_existing_matches_IN + "; color = " + color_IN );
    
    // is text passed in OK?
    is_text_OK = CONTEXT_TEXT.is_string_OK( find_text_IN );
    if ( is_text_OK == true )
    {
        ...
        CONTEXT_TEXT.find_strings_in_article_text( find_in_text_list, clear_existing_matches_IN, color_IN );

    } //-- END to make sure we have text. --//

} //-- END function CONTEXT_TEXT.find_in_article_text() --//
 ...
 *     passed in are assigned "foundInText".
 */
CONTEXT_TEXT.find_words_in_article_text = function( find_text_IN,
                                                 clear_existing_matches_IN,
                                                 color_IN )
{
    
    // declare variables
    var me = "CONTEXT_TEXT.find_words_in_article_text";
    ...
    CONTEXT_TEXT.log_message( "In " + me + "(): find_text_IN = " + find_text_IN );
    ...
    if ( is_text_OK == true )
    {
        ...
        // just search in the article text element.
        CONTEXT_TEXT.find_words_in_html_element( find_text_IN,
...
} //-- END function CONTEXT_TEXT.find_words_in_article_text() --//
// ! ==> single string --> CONTEXT_TEXT.find_words_in_html_element
 ...
 */
CONTEXT_TEXT.find_words_in_html_element = function( find_text_IN,
                                                 ...
                                                 color_IN )
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.find_words_in_html_element";
    var do_clear_matches = false;
    var is_boolean_OK = false;
    var is_text_OK = false;
    var article_paragraphs = null;
    ...
    if ( is_text_OK == true )
    {
        ...
        // just search in the article text element.
        CONTEXT_TEXT.text_finder.find_text_in_element( element_to_search_IN, find_in_text_list );
...
} //-- END function CONTEXT_TEXT.find_words_in_html_element() --//
// ! ==> word list --> CONTEXT_TEXT.text_finder.find_text_in_element
 ...
 * Postconditions: None.
 */
CONTEXT_TEXT.get_article_body = function()
{
 ...
 * Postconditions: None.
 */
CONTEXT_TEXT.get_article_paragraphs = function()
{
    ...
    // declare variables
    var me = "CONTEXT_TEXT.get_article_paragraphs";
    var article_view_div_id = "";
    var article_view_div = null;
    
    // retrieve <div> that contains article text (id/name = "article_view").
    article_view_div = CONTEXT_TEXT.get_article_body();
...
} //-- END function CONTEXT_TEXT.get_article_paragraphs() --//
 ...
 */
CONTEXT_TEXT.highlight_unique_words = function( find_in_text_list_IN, color_IN )
{
    ...
    for ( text_index = 0; text_index < find_in_text_count; text_index++ )
    {
        ...
        CONTEXT_TEXT.log_message( "In " + me + " - highlighting current_text: \"" + current_text + "\"" );
    ...
    CONTEXT_TEXT.log_message( "In " + me + " - unique word list: " + unique_word_list );
    //console.log( "In " + me + " - unique word list: " + unique_word_list );

    CONTEXT_TEXT.find_strings_in_article_text( unique_word_list, false, color_IN );
        
} //-- END function CONTEXT_TEXT.highlight_words --//


CONTEXT_TEXT.send_text_to_find_input = function( text_to_find_IN )
{
    // declare variables
    var me = "CONTEXT_TEXT.send_text_to_find_input";
    var value = "";
    var input_element = "";
    var element_id = "";
    ...
    element_id = '#' + CONTEXT_TEXT.INPUT_ID_TEXT_TO_FIND_IN_ARTICLE;
    input_element = $( element_id );
    input_element.val( value );
    
    CONTEXT_TEXT.log_message( "In " + me + " - sending text : " + value + "; to element_id : " + element_id );
} //-- END function CONTEXT_TEXT.send_text_to_find_input() --//
