...
# define OpenCalaisV2ApiResponse class.
class OpenCalaisV2ApiResponse( LoggingHelper ):
    ...
    # Logging variables
    LOGGING_NAME = "context_text.article_coding.open_calais_v2.open_calais_v2_api_response"
    ...
    JSON_NAME_QUOTE_PERSON_URI = "speaker"
    JSON_NAME_QUOTE_QUOTATION_TYPE = "quotationtype"
    QUOTATION_TYPE_PRIMARY = "Primary"
    QUOTATION_TYPE_PARAPHRASE = "Paraphrase"
    ...
    def __init__( self ):
        ...
        super( OpenCalaisV2ApiResponse, self ).__init__()
