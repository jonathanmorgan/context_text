...
site.addsitedir( '<$HOME>/.virtualenvs/sourcenet/local/lib/python2.7/site-packages' )
...
activate_env = os.path.expanduser( "<$HOME>/.virtualenvs/sourcenet/bin/activate_this.py" )
